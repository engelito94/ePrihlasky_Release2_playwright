...
def test_prihlaska_na_SS_1_kolo(page: Page, person_data) -> None:
    ...
    expect(page.locator("#suhrnny-prehlad")).to_contain_text("-")
    expect(page.locator("#suhrnny-prehlad")).to_contain_text("1. kolo")
...
def test_doplnenie_prilohy_na_SS_1_kolo(page: Page, person_data) -> None:
    ...
    expect(page.locator("div.stavPrihlasky.badge")).to_contain_text("Doplnená")
